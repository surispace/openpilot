...
procs = [
  ...
  PythonProcess("micd", "openpilot.system.micd", iscar, wait_for_ready=True, restart_if_crash=True),
  ...
  PythonProcess("soundd", "openpilot.selfdrive.ui.soundd", driverview, wait_for_ready=True, restart_if_crash=True),
