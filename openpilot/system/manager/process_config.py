...
procs = [
  ...
  PythonProcess("micd", "openpilot.system.micd", iscar, restart_if_crash=True),
  ...
  PythonProcess("soundd", "openpilot.selfdrive.ui.soundd", driverview, restart_if_crash=True),
